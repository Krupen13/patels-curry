...
export function renderPaymentSummary() {
  ...
  const total = totalIncludingTax;
   ...
   const paymentSummaryHTML = ` 
            ...
            <button <a href="https://buy.stripe.com/test_fZe3d99mG5nM1bi144" target="_blank">  class="w-full pt-2 pb-2 pl-6 pr-6  mb-3 text-2xl font-bold text-black bg-pink-300 rounded-xl hover:text-white placed-your-order hover:bg-pink-200 active:bg-pink-100 button-primary" </a>>
              Place your order
            </button>
